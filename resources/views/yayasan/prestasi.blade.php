        ...
        <div class="w-full max-w-[1400px]">
            ...
            <div id="prestasi-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                @forelse ($prestasiItems as $item)
                    ...
                    @endphp
                    <a
                        href="{{ route('yayasan.prestasi.show', ['slug' => $item->slug]) }}"
                    ...
                    >
                        ...
                        <div class="flex flex-col flex-1 p-5">
                            ...
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white leading-tight mb-2 group-hover:text-[#FDB913] transition-colors">{{ $title }}</h3>
                            @if ($excerpt)
                                <p class="text-sm text-slate-600 dark:text-slate-400 line-clamp-2 flex-1">{{ $excerpt }}</p>
                            @endif
                            <div class="mt-4 flex items-center gap-1 text-xs font-bold text-[#FDB913] opacity-0 group-hover:opacity-100 transition-opacity">
                                Baca Selengkapnya
