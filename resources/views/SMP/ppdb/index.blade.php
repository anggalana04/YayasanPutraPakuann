...
@php
    ...
    $schoolModel = School::where('type', $schoolType)->first();

    $totalApplicants = PpdbApplication::where('school_type', $schoolType)->count();
    $verifiedApplicants = PpdbApplication::where('school_type', $schoolType)
    ...
    <main class="mx-auto w-full max-w-7xl px-6 lg:px-10">
                ...
                <div class="relative">
                    ...
                    <div class="absolute -bottom-6 -left-6 rounded-2xl bg-white p-6 shadow-xl dark:bg-slate-800 lg:p-8">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="text-2xl font-bold text-charcoal dark:text-white">{{ number_format($verifiedApplicants) }}</p>
        ...
        <section class="py-16">
            <div class="mb-12 text-center">
                ...
                <p class="mx-auto mt-4 max-w-2xl text-slate-600 dark:text-slate-400">Ikuti langkah-langkah mudah berikut untuk menjadi bagian dari keluarga besar SMP Putra Pakuan.</p>
            </div>
        ...
        <a class="fixed bottom-6 right-6 z-60 flex h-16 w-16 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl transition-transform hover:scale-110 active:scale-95" href="{{ route('school.kontak', ['school' => $school]) }}">
