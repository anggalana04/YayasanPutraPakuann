            ...
            <div id="tentang-kami">
                ...
                <div class="prose prose-lg text-slate-600 space-y-4">
                    ...
                    <p class="leading-relaxed mt-4">
                        SMP Putra Pakuan didukung oleh tenaga pendidik profesional yang sangat memahami kebutuhan dan potensi setiap peserta didik. Dengan lingkungan belajar yang inspiratif dan fasilitas lengkap, kami berkomitmen mencetak lulusan yang siap melanjutkan pendidikan ke jenjang yang lebih tinggi.
                    </p>
                </div>
            </div>
...
<section id="visi-misi" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
    <h2 class="text-3xl font-black mb-4 flex items-center gap-3">
        <span class="w-2 h-8 bg-primary rounded-full"></span>
        Visi & Misi SMP Putra Pakuan
    </h2>
    <p class="text-slate-600 mb-12">Arah dan tujuan yang menjadi landasan SMP Putra Pakuan dalam menyelenggarakan pendidikan menengah pertama yang berkualitas dan berkarakter.</p>
