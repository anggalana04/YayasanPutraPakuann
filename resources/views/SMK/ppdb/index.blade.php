    ...
    <main class="mx-auto w-full max-w-7xl px-6 lg:px-10">
        ...
        <section class="py-12 lg:py-20">
            <div class="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
                ...
                <div class="relative">
                    <div class="aspect-square w-full overflow-hidden rounded-3xl bg-slate-200 dark:bg-slate-800" style="background-image: url('https://images.pexels.com/photos/5265333/pexels-photo-5265333.jpeg?auto=compress&cs=tinysrgb&w=1260&fit=max'); background-size: cover; background-position: center;"></div>
                </div>
            </div>
        </section>
        <!-- Admission Steps -->
