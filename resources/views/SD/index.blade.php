        ...
        if ($heroSlides->isEmpty()) {
            $heroSlides = collect([
                [
                    ...
                    'description' => 'SDIT Putra Pakuan memberikan pendidikan berkualitas dengan fasilitas modern dan tenaga pengajar profesional untuk masa depan gemilang.',
...
@include('partials.school-homepage', [
    'schoolConfig' => [
        ...
        'short_name' => 'SD',
        'stats' => [
            ['number' => 18,  'suffix' => '+', 'label' => 'Tahun Berdiri'],
            ['number' => 600, 'suffix' => '+', 'label' => 'Siswa Aktif'],
            ['number' => 120, 'suffix' => '+', 'label' => 'Prestasi'],
            ['number' => 20,  'suffix' => '+', 'label' => 'Ekstrakurikuler'],
        ],
        'keunggulan' => [
            [
                'icon'       => 'menu_book',
                'title'      => 'Tahfidz Al-Quran',
                'desc'       => 'Program hafalan Al-Quran terintegrasi dalam kurikulum harian yang terstruktur dan menyenangkan.',
                'bg_from'    => '#064e3b',
                'bg_to'      => '#065f46',
                'glow'       => '#10b981',
                'icon_color' => '#6ee7b7',
            ...
            [
                ...
                'desc'       => 'Pembelajaran dua bahasa: Indonesia dan Inggris aktif sejak kelas 1 dengan metode komunikatif.',
                'bg_from'    => '#1e3a5f',
                'bg_to'      => '#1d4ed8',
                'glow'       => '#3b82f6',
                'icon_color' => '#93c5fd',
            ...
            [
                ...
                'desc'       => 'Pembentukan akhlak mulia berbasis nilai Islam dalam setiap aspek kehidupan sekolah.',
                'bg_from'    => '#3b0764',
                'bg_to'      => '#4c1d95',
                'glow'       => '#8b5cf6',
                'icon_color' => '#c4b5fd',
            ...
            [
                'icon'       => 'science',
                'title'      => 'STEM Terpadu',
                'desc'       => 'Science, Technology, Engineering dan Math dengan pendekatan menyenangkan dan kontekstual.',
                'bg_from'    => '#7c2d12',
                'bg_to'      => '#9a3412',
                'glow'       => '#f97316',
                'icon_color' => '#fdba74',
        ...
        'kurikulum' => [
            [
                ...
                'desc'      => 'Target hafalan 2–3 juz selama 6 tahun dengan metode talaqqi bersama ustadz berpengalaman.',
                'color_hex' => '#10b981',
            ...
            [
                ...
                'desc'      => 'Pembelajaran Bahasa Inggris aktif sejak kelas 1 dengan pendekatan komunikatif dan menyenangkan.',
                'color_hex' => '#3b82f6',
            ...
            [
                'icon'      => 'science',
                'title'     => 'STEM & Robotika',
                'desc'      => 'Eksplorasi sains, teknologi, rekayasa, dan matematika melalui pembelajaran berbasis proyek.',
                'color_hex' => '#f97316',
                'bg_hex'    => 'rgba(249,115,22,0.08)',
            ],
            [
                'icon'      => 'palette',
                'title'     => 'Seni & Pengembangan Bakat',
                'desc'      => '20+ ekstrakurikuler dari musik, tari, pramuka, dan olahraga untuk mengembangkan bakat siswa.',
                'color_hex' => '#8b5cf6',
                'bg_hex'    => 'rgba(139,92,246,0.08)',
            ],
        ],
        'ppdb_offline_text' => 'Pendaftaran pelajar baru untuk SDIT Putra Pakuan belum dibuka. Mohon menunggu pengumuman resmi.',
        'galeri_desc'       => 'Dokumentasi kegiatan dan momen spesial terbaru dari SDIT Putra Pakuan.',
    ],
])
<script>
    // Hero Carousel
