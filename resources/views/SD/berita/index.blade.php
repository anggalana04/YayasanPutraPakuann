    ...
    <div class="flex flex-col gap-3">
        <div class="max-w-2xl">
            <h1 class="text-4xl lg:text-5xl font-black leading-tight tracking-[-0.033em] mb-3 text-charcoal dark:text-white">
                Berita & Pengumuman SDIT
            </h1>
            <p class="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">Informasi terbaru untuk siswa, guru, dan orang tua SDIT Putra Pakuan.</p>
        </div>
    </div>
