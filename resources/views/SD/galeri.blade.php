...
@section('title', 'Galeri - SDIT Putra Pakuan')
...
<a class="hover:text-primary" href="{{ route('school.home', ['school' => 'smp']) }}">Beranda</a>
<span>/</span>
...
Dokumentasi momen berharga, prestasi gemilang, dan inovasi siswa SMP Putra Pakuan dalam menggapai masa depan yang cerah.
</p>
</div>
...
<div>
<h3 class="font-bold text-lg mb-1 group-hover:text-primary transition-colors">Profil SMP Putra Pakuan 2024</h3>
...
<p class="font-medium opacity-80">Segera daftarkan dirimu dan raih masa depan gemilang di SMP Putra Pakuan.</p>
</div>
