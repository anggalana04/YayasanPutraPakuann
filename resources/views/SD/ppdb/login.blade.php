...
<title>Masuk PPDB SDIT Putra Pakuan</title>
<meta name="description" content="Masuk ke portal PPDB SDIT Putra Pakuan untuk memantau status pendaftaran, berkas, dan tahapan seleksi." />
<meta name="keywords" content="masuk ppdb sdit putra pakuan, login sdit bogor, portal ppdb sdit" />
...
<meta property="og:title" content="Masuk PPDB SDIT Putra Pakuan" />
<meta property="og:description" content="Masuk ke portal PPDB SDIT Putra Pakuan untuk memantau status pendaftaran, berkas, dan tahapan seleksi." />
<meta property="og:url" content="{{ url()->current() }}" />
<meta property="og:image" content="{{ asset('images/logo-sdit-putrapakuan.png') }}" />
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:title" content="Masuk PPDB SDIT Putra Pakuan" />
<meta name="twitter:description" content="Masuk ke portal PPDB SDIT Putra Pakuan untuk memantau status pendaftaran, berkas, dan tahapan seleksi." />
...
<img alt="Kampus SDIT Putra Pakuan" class="w-full h-full object-cover" data-alt="Modern high school building architecture with students" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCKdkaLXz_vEAKlO3wCc9sxTZt1OfD9tXutglzPJ7A88GeNnGo969ibDMYOSSEBbSYrDHOfoCt7Cah1cp24q5FEV3mZA3asUQA73QsegQm7aUg685JXM4egFTqDCLurVXAH9Svvbw4VUqXwv66Fl5Ieu-IXTsq5ai-9mus2vkc1SQ9Jgtv349mTajGBzpfujbKoQgv7ojgZfMtBv7_x_b8SHXUQgk5EXlc3Cwq1pC5jylGQ6Q4kKH3s9C0OkCVWnWfGF86uZhHNZxE"/>
</div>
<!-- Gradient Overlay -->
...
<p class="text-lg text-on-primary-fixed-variant leading-relaxed">
                        Bergabunglah dengan komunitas akademik terbaik. Daftarkan diri Anda dan mulailah perjalanan prestasi bersama SDIT Putra Pakuan Bogor.
                    </p>
</div>
...
<h2 class="text-lg font-extrabold tracking-tighter text-on-surface">SDIT Putra Pakuan</h2>
</div>
</div>
...
<a class="w-full bg-white border border-outline-variant/30 text-on-surface font-bold py-4 px-6 rounded-xl shadow-sm hover:bg-surface-container-low hover:scale-[1.01] active:scale-95 transition-all flex items-center justify-center gap-3 group" href="{{ url('/auth/google/redirect') }}">
