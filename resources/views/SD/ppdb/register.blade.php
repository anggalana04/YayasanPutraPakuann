...
<title>Daftar Akun PPDB SDIT Putra Pakuan</title>
<meta name="description" content="Registrasi akun PPDB SDIT Putra Pakuan untuk memulai pendaftaran siswa baru dengan proses online yang mudah." />
<meta name="keywords" content="daftar ppdb sdit putra pakuan, registrasi sdit bogor, ppdb online sdit" />
...
<meta property="og:title" content="Daftar Akun PPDB SDIT Putra Pakuan" />
<meta property="og:description" content="Registrasi akun PPDB SDIT Putra Pakuan untuk memulai pendaftaran siswa baru dengan proses online yang mudah." />
<meta property="og:url" content="{{ url()->current() }}" />
<meta property="og:image" content="{{ asset('images/logo-sdit-putrapakuan.png') }}" />
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:title" content="Daftar Akun PPDB SDIT Putra Pakuan" />
<meta name="twitter:description" content="Registrasi akun PPDB SDIT Putra Pakuan untuk memulai pendaftaran siswa baru dengan proses online yang mudah." />
<meta name="twitter:image" content="{{ asset('images/logo-sdit-putrapakuan.png') }}" />
...
<a class="font-lexend text-sm font-medium tracking-tight text-[#1c190d]/60 hover:opacity-80 transition-opacity" href="{{ route('school.kontak', ['school' => $school]) }}">Bantuan</a>
<a class="px-5 py-2 rounded-full bg-primary-container text-on-primary-fixed font-semibold text-sm hover:scale-95 duration-200 transition-transform" href="{{ route('ppdb.login', ['school' => $school]) }}">
                    Masuk
                </a>
</div>
</div>
...
<p class="text-on-surface-variant text-lg leading-relaxed max-w-md">
                        Daftarkan akun Anda untuk memulai proses seleksi, memantau status aplikasi, dan mendapatkan pembaruan terkini seputar PPDB SDIT Putra Pakuan.
                    </p>
</div>
<div class="space-y-6">
...
<input name="full_name" class="w-full bg-surface-container-low border-none rounded-2xl px-5 py-4 text-sm focus:ring-0 focus:bg-surface-container-lowest transition-all placeholder:text-outline-variant" placeholder="Masukkan nama sesuai ijazah" type="text" required/>
...
<div class="relative group">
<input name="email" class="w-full bg-surface-container-low border-none rounded-2xl px-5 py-4 text-sm focus:ring-0 focus:bg-surface-container-lowest transition-all placeholder:text-outline-variant" placeholder="contoh@email.com" type="email" required/>
<div class="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-primary transition-all group-focus-within:w-full"></div>
</div>
</div>
<div class="space-y-1.5">
...
<div class="relative group">
<input name="phone" class="w-full bg-surface-container-low border-none rounded-2xl px-5 py-4 text-sm focus:ring-0 focus:bg-surface-container-lowest transition-all placeholder:text-outline-variant" placeholder="08xx xxxx xxxx" type="tel"/>
<div class="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-primary transition-all group-focus-within:w-full"></div>
</div>
</div>
<div class="space-y-1.5">
...
<a class="w-full flex items-center justify-center gap-3 py-4 bg-white border border-surface-container-high text-on-surface font-bold rounded-2xl hover:bg-surface-container-low transition-all shadow-sm" href="{{ url('/auth/google/redirect') }}">
...
<p class="text-sm text-on-surface-variant">
                                Sudah punya akun?
                                <a class="text-primary font-bold hover:underline" href="{{ route('ppdb.login', ['school' => $school]) }}">Masuk</a>
</p>
</div>
</form>
</div>
