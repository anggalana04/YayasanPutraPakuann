    ...
    <nav id="school-nav" class="fixed top-0 z-50 w-full {{ $__sdIsHero ? '' : 'bg-charcoal border-b border-primary/20' }} text-white transition-all duration-300">
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div class="hidden lg:flex items-center gap-6">
                ...
                <a class="text-xs font-semibold hover:text-primary transition-colors" href="{{ route('school.prestasi', ['school' => request()->route('school') ?? 'sd']) }}">PRESTASI</a>
        ...
        <div id="mobile-menu" class="fixed inset-0 z-50 bg-charcoal/95 text-white flex flex-col gap-6 px-8 py-10 transition-all duration-300 translate-x-full lg:hidden" style="display:none;">
            ...
            <a class="text-base font-semibold hover:text-primary transition-colors" href="{{ route('school.prestasi', ['school' => request()->route('school') ?? 'sd']) }}">PRESTASI</a>
