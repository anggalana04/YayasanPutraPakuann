...
<head>
    ...
    @php
        $seoTitle = trim($__env->yieldContent('title', 'SPMB SDIT Putra Pakuan | Pendaftaran Peserta Didik Baru'));
        $seoDescription = trim($__env->yieldContent('meta_description', 'Daftar SPMB SDIT Putra Pakuan secara online. Lengkapi biodata, unggah berkas, dan pantau status seleksi kapan saja.'));
        $seoKeywords = trim($__env->yieldContent('meta_keywords', 'spmb sdit putra pakuan, pendaftaran sdit bogor, spmb online sdit'));
    ...
    <meta name="author" content="SPMB SDIT Putra Pakuan" />
    ...
    <meta property="og:site_name" content="SPMB SDIT Putra Pakuan" />
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                <a href="{{ route('ppdb.dashboard', ['school' => $school]) }}" class="flex items-center space-x-2">
                    ...
                    <span class="font-bold text-lg text-primary">SPMB SDIT Putra Pakuan</span>
                </a>
            </div>
            @php
