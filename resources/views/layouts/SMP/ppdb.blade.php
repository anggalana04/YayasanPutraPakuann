...
<head>
    ...
    @php
        $seoTitle = trim($__env->yieldContent('title', 'SPMB SMP Putra Pakuan | Pendaftaran Peserta Didik Baru'));
        $seoDescription = trim($__env->yieldContent('meta_description', 'Daftar SPMB SMP Putra Pakuan secara online. Isi biodata, unggah berkas, dan cek perkembangan seleksi dengan cepat.'));
        $seoKeywords = trim($__env->yieldContent('meta_keywords', 'spmb smp putra pakuan, pendaftaran smp bogor, spmb online smp'));
    ...
    <meta name="author" content="SPMB SMP Putra Pakuan" />
    ...
    <meta property="og:site_name" content="SPMB SMP Putra Pakuan" />
    ...
    @php
        $schoolBaseUrl = route('school.home', ['school' => 'smp']);
        $orgSchema = [
