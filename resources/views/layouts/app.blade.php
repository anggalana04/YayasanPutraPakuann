    ...
    <div class="relative flex min-h-screen w-full flex-col group/design-root">
        ...
        <div id="fab" class="fixed z-[99] bottom-6 right-6 flex flex-col items-end gap-3">
            ...
            <div id="fab-actions" class="flex flex-col items-end gap-3 mb-2 hidden">
                ...
                <a href="{{ route('yayasan.fasilitas') }}" class="flex items-center gap-2 px-4 py-2 rounded-lg bg-white text-[#FDB913] shadow-lg border border-[#FDB913] hover:bg-[#FDB913] hover:text-slate-900 transition-all">
                    <span class="material-symbols-outlined">school</span> Lihat Fasilitas
                </a>
            </div>
            <!-- Main FAB Button -->
            <button id="fab-main" class="flex items-center justify-center w-14 h-14 rounded-full bg-[#FDB913] text-slate-900 shadow-2xl text-3xl hover:bg-[#E5A800] transition-all focus:outline-none">
            ...
            <div class="layout-container flex flex-col items-center w-full px-4 md:px-10">
                <div class="max-w-[1280px] w-full grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <a class="text-slate-500 hover:text-[#FDB913] text-sm transition-colors" href="#">Sejarah</a>
                        <a class="text-slate-500 hover:text-[#FDB913] text-sm transition-colors" href="#">Visi &amp; Misi</a>
                        <a class="text-slate-500 hover:text-[#FDB913] text-sm transition-colors" href="#">Struktur Organisasi</a>
                    </div>
                    <div class="flex flex-col gap-3">
                        <h4 class="text-text-main dark:text-white font-bold text-sm">Informasi</h4>
                        <a class="text-slate-500 hover:text-[#FDB913] text-sm transition-colors" href="#">Berita Sekolah</a>
                        <a class="text-slate-500 hover:text-[#FDB913] text-sm transition-colors" href="#">Karir</a>
                        <a class="text-slate-500 hover:text-[#FDB913] text-sm transition-colors" href="#">Alumni</a>
                    </div>
                    <div class="flex flex-col gap-3">
                        <h4 class="text-text-main dark:text-white font-bold text-sm">Hubungi Kami</h4>
                        <a class="flex items-center gap-2 text-slate-500 hover:text-[#FDB913] text-sm transition-colors" href="#">
