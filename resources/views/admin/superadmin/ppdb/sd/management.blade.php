...
@section('title', 'Manajemen SPMB - SDIT Putra Pakuan CMS')
            ...
            <form method="POST" action="{{ route('admin.cms.payment_settings.update', ['schoolType' => $schoolTypeSlug]) }}" class="px-6 py-6">
                ...
                <div x-show="paymentTab === 'bank'" class="space-y-3 mb-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="payment_bank_holder" value="{{ old('payment_bank_holder', $homepage?->payment_bank_holder) }}" placeholder="Contoh: SDIT PUTRA PAKUAN" class="w-full px-4 py-2.5 rounded-xl border border-outline-variant/50 bg-surface-container-low text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition">
                    </div>
                </div>
