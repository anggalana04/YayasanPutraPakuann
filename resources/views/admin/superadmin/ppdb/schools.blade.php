                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-[#1c190d]/5">
                        <tr class="hover:bg-surface-container-low/30 transition-colors group">
                            ...
                            <td class="px-6 py-6">
                                <a href="{{ route('admin.ppdb.management') }}" class="bg-[#f2cc0d] text-[#1c190d] px-4 py-2 rounded-xl text-sm font-bold shadow-sm hover:scale-[1.02] active:scale-95 transition-all inline-block">Manage</a>
                            </td>
                        </tr>
                        <tr class="hover:bg-surface-container-low/30 transition-colors group">
