            ...
            <form id="decisionForm" class="space-y-4">
                ...
                <button type="button"
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-xs text-gray-500">Penerimaan Umum SMP</span>
                    </div>
                    <p class="text-xs mt-2 text-gray-600">Terima pendaftar ini sebagai siswa SMP reguler.</p>
                </button>
                ...
                <div x-show="showForm"
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input id="promote-class" type="text" placeholder="VII / VIII / IX"
                                   class="w-full px-4 py-2.5 rounded-2xl border border-outline-variant bg-surface text-sm text-on-surface focus:outline-none focus:border-primary transition-colors">
                        </div>
                        <div>
