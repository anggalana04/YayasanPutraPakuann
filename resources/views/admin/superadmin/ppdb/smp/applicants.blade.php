    ...
    (() => {
        ...
        function renderApplicantRows(applicants, page = 1) {
            ...
            applicantTableBody.innerHTML = applicants.map((app, idx) => {
                ...
                const paymentTypeLabel = app.payment_method ? app.payment_method.replace(/_/g, ' ').toUpperCase() : '—';
                ...
                return `
                    <tr class="hover:bg-surface-container-low/50 transition-colors group">
                        ...
                        <td class="px-4 py-3 font-mono text-on-surface-variant">${app.application_id}</td>
                        ...
                        <td class="px-4 py-3 text-on-surface-variant text-xs">${paymentTypeLabel}</td>
        ...
        async function loadFilteredData(page = 1) {
            ...
            if (registrationStepFilter?.value && registrationStepFilter.value !== 'all') params.append('registration_step', registrationStepFilter.value);
